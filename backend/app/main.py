...
import numpy as np
#rom psycopg2.extensions import register_adapter, AsIs
import json
import os
import psycopg2
...
#conn = psycopg2.connect("dbname='postgres' user='postgres' host='localhost' password='password' port='3001'")

#conn = psycopg2.connect("postgresql://postgres:password@host.docker.internal:3001/postgres")
#cur = conn.cursor()
